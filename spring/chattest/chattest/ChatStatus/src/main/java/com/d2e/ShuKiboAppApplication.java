...
public class ShuKiboAppApplication {

	//private static Log logger =  LogFactory.getLog(ShuKiboAppApplication.class);
	public static void main(String[] args) {
		SpringApplication.run(ShuKiboAppApplication.class, args);
