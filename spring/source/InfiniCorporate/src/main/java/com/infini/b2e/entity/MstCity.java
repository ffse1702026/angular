...
public class MstCity implements Serializable {
    ...
    @OneToMany(mappedBy = "city_code", cascade=CascadeType.MERGE)
    private List<MstAirport> listMstAirport;
    ...
    /**
     * @return the city_name_jp
     */
    public String getCity_name_jp() {
        return city_name_jp;
    }

    /**
     * @param city_name_jp
     *            the city_name_jp to set
     */
    public void setCity_name_jp(String city_name_jp) {
        this.city_name_jp = city_name_jp;
    }

    /**
     * @return the city_name_en
     */
    ...
    /**
     * @return the listMstAirport
     */
    public List<MstAirport> getListMstAirport() {
        return listMstAirport;
    }

    /**
     * @param listMstAirport the listMstAirport to set
     */
    public void setListMstAirport(List<MstAirport> listMstAirport) {
        this.listMstAirport = listMstAirport;
    }
