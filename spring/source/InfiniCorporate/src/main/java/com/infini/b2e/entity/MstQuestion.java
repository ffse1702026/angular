...
public class MstQuestion {
    @Id
    private int id;
    private String question_code;
    private String question_content_jp;
    private String question_content_en;
    ...
    /**
     * @return the question_code
     */
    public String getQuestion_code() {
        return question_code;
    }
    /**
     * @param question_code the question_code to set
     */
    public void setQuestion_code(String question_code) {
        this.question_code = question_code;
    }
    /**
     * @return the question_content_jp
     */
    public String getQuestion_content_jp() {
        return question_content_jp;
    }
    /**
     * @param question_content_jp the question_content_jp to set
     */
    public void setQuestion_content_jp(String question_content_jp) {
        this.question_content_jp = question_content_jp;
    }
    /**
     * @return the question_content_en
     */
    public String getQuestion_content_en() {
        return question_content_en;
    }
    /**
     * @param question_content_en the question_content_en to set
     */
    public void setQuestion_content_en(String question_content_en) {
        this.question_content_en = question_content_en;
    }
    /**
     * @return the yobi1
     */
